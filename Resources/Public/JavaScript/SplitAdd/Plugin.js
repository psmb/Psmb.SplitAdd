...
var _splitPlugin = __webpack_require__(20);

var _splitPlugin2 = _interopRequireDefault(_splitPlugin);

var _SplitAddButton = __webpack_require__(55);

var _SplitAddButton2 = _interopRequireDefault(_SplitAddButton);
...
(0, _neosUiExtensibility2.default)('Psmb.SplitAdd:SplitAdd', {}, function (globalRegistry) {
    ...
    config.set('splitAdd', addPlugin(_splitPlugin2.default));
});
...
module.exports = {"name":"@neos-project/neos-ui-extensibility","version":"1.3.0","description":"Extensibility mechanisms for the Neos CMS UI","main":"./src/index.js","scripts":{"prebuild":"check-dependencies && yarn clean","test":"yarn jest -- -w 2 --coverage","test:watch":"yarn jest -- --watch","build":"exit 0","build:watch":"exit 0","clean":"rimraf ./lib ./dist","lint":"eslint src","jest":"NODE_ENV=test jest"},"devDependencies":{"@neos-project/babel-preset-neos-ui":"1.3.0","@neos-project/jest-preset-neos-ui":"1.3.0"},"dependencies":{"@neos-project/build-essentials":"1.3.0","@neos-project/positional-array-sorter":"1.3.0","babel-core":"^6.13.2","babel-eslint":"^7.1.1","babel-loader":"^7.1.2","babel-plugin-transform-decorators-legacy":"^1.3.4","babel-plugin-transform-object-rest-spread":"^6.20.1","babel-plugin-webpack-alias":"^2.1.1","babel-preset-es2015":"^6.13.2","babel-preset-react":"^6.3.13","babel-preset-stage-0":"^6.3.13","chalk":"^1.1.3","css-loader":"^0.28.4","file-loader":"^1.1.5","json-loader":"^0.5.4","postcss-loader":"^2.0.10","react-dev-utils":"^0.5.0","style-loader":"^0.21.0"},"bin":{"neos-react-scripts":"./bin/neos-react-scripts.js"},"jest":{"preset":"@neos-project/jest-preset-neos-ui"}}
...
var SplitCommand = function (_Command) {
    _inherits(SplitCommand, _Command);

    function SplitCommand() {
        _classCallCheck(this, SplitCommand);

        return _possibleConstructorReturn(this, (SplitCommand.__proto__ || Object.getPrototypeOf(SplitCommand)).apply(this, arguments));
    }

    _createClass(SplitCommand, [{
        key: 'execute',
        value: function execute(callback) {
            var editor = this.editor;
            var range = editor.model.document.selection.getFirstRange();
            var element = range.start.parent;
            editor.model.change(function (writer) {
                var marker = writer.createElement('paragraph');
                writer.insertText('###NEOS_SPLIT###', marker, 'end');
                writer.insert(marker, element, 'after');
                var content = editor.getData();

                var _content$split = content.split('<p>###NEOS_SPLIT###</p>'),
                    _content$split2 = _slicedToArray(_content$split, 2),
                    contentBefore = _content$split2[0],
                    contentAfter = _content$split2[1];

                editor.setData(contentBefore);
                var _editor$neos = editor.neos,
                    contextPath = _editor$neos.contextPath,
                    propertyName = _editor$neos.propertyName,
                    nodeType = _editor$neos.nodeType;

                callback({ contentBefore: contentBefore, contentAfter: contentAfter, contextPath: contextPath, propertyName: propertyName, nodeType: nodeType });
            });
        }
    }]);
...
var Split = function (_Plugin) {
    _inherits(Split, _Plugin);
...
var SplitAddButton = (_dec = (0, _reactRedux.connect)((0, _plowJs.$transform)({
    ...
    _inherits(SplitAddButton, _PureComponent);
    ...
    function SplitAddButton() {
        ...
        _classCallCheck(this, SplitAddButton);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SplitAddButton.__proto__ || Object.getPrototypeOf(SplitAddButton)).call.apply(_ref, [this].concat(args))), _this), _this.handleSplit = function (_ref2) {
            var contentAfter = _ref2.contentAfter,
            ...
            _this.props.persistChanges([{
                ...
                subject: contextPath,
                payload: _extends({}, (0, _dom.calculateDomAddresses)(contextPath, _this.props.fusionPath), {
                    nodeType: nodeType.name,
                    data: {
                        properties: _defineProperty({}, propertyName, contentAfter)
                    }
                })
            }]);
            _this.props.commenceNodeCreation(contextPath, _this.props.fusionPath);
        }, _this.handleClick = function () {
            (0, _neosUiCkeditor5Bindings.executeCommand)('neosSplit', _this.handleSplit);
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }

    _createClass(SplitAddButton, [{
        key: 'render',
...
var findInGuestFrame = function findInGuestFrame(selector) {
    return getGuestFrameDocument().querySelector(selector);
};
var findNodeInGuestFrame = function findNodeInGuestFrame(contextPath, fusionPath) {
    return fusionPath ? findInGuestFrame('[data-__neos-node-contextpath="' + contextPath + '"][data-__neos-fusion-path="' + fusionPath + '"]') : findInGuestFrame('[data-__neos-node-contextpath="' + contextPath + '"]');
};
var closestNodeInGuestFrame = function closestNodeInGuestFrame(el) {
    if (!el || !el.dataset) {
...
var calculateDomAddresses = exports.calculateDomAddresses = function calculateDomAddresses(contextPath, fusionPath) {
    var element = findNodeInGuestFrame(contextPath, fusionPath);
    var parentElement = element ? closestNodeInGuestFrame(element.parentNode) : null;
